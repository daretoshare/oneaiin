...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="text-center">
      <div className="font-display text-3xl md:text-4xl" style={{ color: 'var(--text-primary)' }}>
        {value}
      </div>
      <div
        className="font-mono text-[0.65rem] uppercase tracking-wider mt-1"
...
function AuthorCard({
  ...
  return (
    <div className="card">
      <div className="flex items-start gap-3 mb-5">
        <div
          ...
          style={{
            background: bgColor,
            color: dotColor,
            border: `1px solid ${color === 'accent' ? 'var(--accent-border)' : 'rgba(52,211,153,0.15)'}`,
          }}
        >
          {initials}
        </div>
      ...
      <div className="mb-4">
        <p
          className="font-mono text-[0.6rem] uppercase tracking-wider mb-2"
          style={{ color: 'var(--text-muted)' }}
        >
          Credentials
        </p>
      ...
      <section className="pt-28 pb-20 md:pt-36 md:pb-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            >
              Practitioner-led insights on AI governance, model risk management, and responsible AI
              adoption across{' '}
              <span style={{ color: 'var(--text-primary)' }}>Banking &amp; Financial Services</span>{' '}
              and <span style={{ color: 'var(--text-primary)' }}>Healthcare &amp; Pharma</span>.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-xl mb-12">
            ...
            <p className="text-base" style={{ color: 'var(--text-secondary)' }}>
              Deep practitioner expertise across the two most heavily regulated industries adopting
              AI at scale.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Monthly deep-dive articles on AI governance, model risk, and responsible AI — written by practitioners, for practitioners.',
                when: 'Q2 2026',
              },
              {
                num: '02',
                title: 'Curated Knowledge Base',
                desc: 'Regulatory guidance summaries, framework comparisons, open-source tool reviews, and reference architectures.',
                when: 'Q2 2026',
              },
              {
                num: '03',
                title: 'Video & Newsletter',
                desc: 'Monthly YouTube explainers and a curated newsletter covering the most important developments in enterprise AI governance.',
                when: 'Q3 2026',
              },
            ].map((item) => (
              <div key={item.num} className="card">
                <span className="font-mono text-xs block mb-3" style={{ color: 'var(--accent)' }}>
                  {item.num}
                </span>
                <h3
      ...
      <section id="newsletter" className="py-20 md:py-28">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-base mb-10" style={{ color: 'var(--text-secondary)' }}>
            A monthly newsletter distilling the most important developments in AI governance. No
            fluff. Practitioner-grade insight.
          </p>
